...
YAHOO.extend(SoftwareLoop.UploaderPlusAdmin,Alfresco.component.Base,{uploadFoldersListUrl:Alfresco.constants.PROXY_URI+"uploader-plus/upload-folders-list",listContentTypesUrl:Alfresco.constants.PROXY_URI+"uploader-plus/list-content-types",onReady:function(){Alfresco.logger.debug("onReady",arguments);this.setupDataTable();this.setupNewUploadFolderButton();Alfresco.logger.debug("END onReady")},prettyPath:function(b){Alfresco.logger.debug("prettyPath",arguments);var a=b.substring(13);""===a&&(Alfresco.logger.debug("Adjusting root path"),
a="/");Alfresco.logger.debug("END prettyPath",a);return a},pathFormatter:function(b,a,d,e){Alfresco.logger.debug("pathFormatter",arguments);var c=this.prettyPath(e),f=YAHOO.lang.substitute("{pageContext}repository#filter={path}&page=1",{pageContext:Alfresco.constants.URL_PAGECONTEXT,path:encodeURIComponent("path|"+c+"|")});b.innerHTML=YAHOO.lang.substitute("<a href='{href}' title='{title}'>{text}</a>",{href:Alfresco.util.encodeHTML(f),title:this.msg("open.in.repository"),text:Alfresco.util.encodeHTML(c)});
Alfresco.logger.debug("END pathFormatter")},allowedTypesFormatter:function(b,a,d,e){Alfresco.logger.debug("allowedTypesFormatter",arguments);for(var c="",f=0;f<e.length;f++){Alfresco.logger.debug("Adding allowed type",e[f]);0<f&&(c+=", ");var g=this.msg("type."+e[f].replace(":","_"));c=0===g.lastIndexOf("type.",0)?c+Alfresco.util.encodeHTML(e[f]):c+Alfresco.util.encodeHTML(g)}b.innerHTML=c;Alfresco.logger.debug("END allowedTypesFormatter")},actionFormatter:function(b,a,d,e){Alfresco.logger.debug("actionFormatter",
arguments);a.getData();b.innerHTML="<div class='action'><a class='edit-upload-folder'>"+this.msg("button.edit")+"</a> | <a class='delete-upload-folder'>"+this.msg("button.delete")+"</a></div>";Alfresco.logger.debug("END actionFormatter")},setupDataTable:function(){Alfresco.logger.debug("setupDataTable",arguments);var b=[{key:"path",label:this.msg("title.path"),sortable:!1,formatter:SoftwareLoop.hitch(this,this.pathFormatter)},{key:"allowedTypes",label:this.msg("title.allowed.types"),sortable:!1,formatter:SoftwareLoop.hitch(this,
this.allowedTypesFormatter)},{key:"actions",label:this.msg("title.actions"),sortable:!1,formatter:SoftwareLoop.hitch(this,this.actionFormatter)}],a=this.widgets.dataSource=new YAHOO.util.DataSource(this.uploadFoldersListUrl,{responseType:YAHOO.util.DataSource.TYPE_JSON,connXhrMode:"queueRequests",responseSchema:{resultsList:"results",fields:["path","nodeRef","allowedTypes"]}});b=this.widgets.dataTable=new YAHOO.widget.DataTable(this.id+"-folders",b,a,{initialLoad:{},MSG_LOADING:this.msg("loading.folders"),
MSG_EMPTY:this.msg("no.folders.found")});b.subscribe("rowMouseoverEvent",b.onEventHighlightRow);b.subscribe("rowMouseoutEvent",b.onEventUnhighlightRow);YAHOO.util.Event.delegate(this.id,"click",SoftwareLoop.hitch(this,this.editUploadFolderHandler),"a.edit-upload-folder");YAHOO.util.Event.delegate(this.id,"click",SoftwareLoop.hitch(this,this.deleteUploadFolderHandler),"a.delete-upload-folder");Alfresco.logger.debug("END setupDataTable")},setupNewUploadFolderButton:function(){Alfresco.logger.debug("setupNewUploadFolderButton",
